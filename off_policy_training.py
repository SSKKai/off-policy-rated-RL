    ...
    def train(self):
        ...
        for i_episode in itertools.count(1):
            ...
            while not done:
                ...
                if len(self.agent_memory) > self.sac_hyparams.batch_size and self.sac_hyparams.start_steps > self.total_numsteps:
            ...
            if self.rank_count >= 3 and i_episode % 5 == 0:
                print('leanr reward')
...
if __name__ == '__main__':
    sac_hyperparams = {
        ...
        'lr': 0.0001,#default=0.0003 / 0.00005
        ...
        'start_steps': 300000,  #Steps sampling random actions (default: 10000 , 200000)
