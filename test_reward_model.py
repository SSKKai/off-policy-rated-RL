    ...
    def train(self):
        ...
        for i_episode in itertools.count(1):
            ...
            while not done:
                ...
                self.writer.add_scalar('reward/reward_true', reward, self.total_numsteps)
                self.writer.add_scalar('reward/reward_prime', reward_prime, self.total_numsteps)
            ...
            self.writer.add_scalar('e_reward/episode_reward_prime', episode_reward_prime, i_episode)
